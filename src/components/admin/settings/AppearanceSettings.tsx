...
import { useAppearanceSettings } from '@/hooks/admin/settings/useAppearanceSettings';

const AppearanceSettings = () => {
  const { form, handleSubmit } = useAppearanceSettings();
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    ...
                    <SelectContent>
                      <SelectItem value="gold">Rich Gold</SelectItem>
                      <SelectItem value="crimson">Crimson Red</SelectItem>
                      <SelectItem value="brown">Warm Brown</SelectItem>
