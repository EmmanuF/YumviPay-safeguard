  ...
  return (
    <div className="mt-4">
      <PreferenceToggle
        ...
        icon={<RepeatIcon className="h-5 w-5 text-purple-600" />}
        accentColor="purple"
      />
      ...
      <AnimatePresence>
        {isExpanded && (
          <motion.div 
            ...
            className="bg-purple-50/60 backdrop-blur-sm rounded-xl p-5 border border-purple-100/60 mt-3"
          >
            ...
            >
              <SelectTrigger className="w-full bg-white/80 border-purple-200/60 focus:ring-purple-500/30">
            ...
            <p className="text-sm text-gray-600 mt-3 bg-white/40 p-3 rounded-lg border border-purple-100/20">
              <Info className="h-4 w-4 inline-block mr-1 text-purple-400" />
