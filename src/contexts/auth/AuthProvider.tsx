...
// Custom hook for refreshing authentication state
const useAuthRefresh = (setAuthState: React.Dispatch<React.SetStateAction<AuthState>>) => {
...
const useAuthEvents = (refreshAuthState: () => Promise<void>, setAuthState: React.Dispatch<React.SetStateAction<AuthState>>, authState: AuthState) => {
  ...
  }, [refreshAuthState, setAuthState, authState.isLoggedIn]);
};
